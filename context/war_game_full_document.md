...
- Canonical brief: Open — no dossier exists; see JTBD portfolio
...
- Input artifacts: ADV-MORNING-001-SOTA-A001 v1.2 (SOTA); ADV-MORNING-001-MVP-A001 v1.2 (MVP); ADV-MORNING-001-VIS-A001 v0.14 (Vision); ADV-MORNING-001-MET-A001 v1.1 (Metrics); ADV-MORNING-001-GTM-A001 v1.0 (GTM); TAX-PLATFORM-CONTEXT-A001 v0.1 (context); internal SE-DIFM strategy corpus (Notion/Drive, 2026-07-21, see Evidence E023–E033)
...
| MVP-D008/MET-G002 synthetic replay vs live business metrics | Bind ≥1 gate KPI to a tracked live metric; replay proves honesty, not business value (F033). | Ozan / Christine |
...
- Next owner/action: Product closes the design requirements (F026, F029–F033) and the G001 open questions; the controlled-live prerequisites (F022, F024, F025) close at their gates. Fold into the decision record and the canonical JTBD dossier.
